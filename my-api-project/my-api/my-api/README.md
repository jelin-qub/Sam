...
```bash
my-api$ sam build --use-container
```
...
```bash
my-api$ sam logs -n StockCheckerFunction --stack-name "my-api" --tail
```
...
```bash
my-api$ pip install -r tests/requirements.txt --user
# unit test
my-api$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
my-api$ AWS_SAM_STACK_NAME="my-api" python -m pytest tests/integration -v
```
